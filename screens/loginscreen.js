...
disLikedPressed(){
  ...
  render(){
    ...
    <View>
      ...
      <Text style={styles.buttonText}>bioligyscreen</Text>
      </TouchableOpacity>
      
      <TouchableOpacity style={[styles.button, {backgroundColor:'orange'}]} onPress={() => this.props.navigation.navigate('HappyScreen')}>
      <Text style={styles.buttonText}>chemistryscreen</Text>
      </TouchableOpacity>
     
      <TouchableOpacity style={[styles.button, {backgroundColor:'blue'}]} onPress={() => this.props.navigation.navigate('SadScreen')}>
      <Text style={styles.buttonText}>englishscreen</Text>
      </TouchableOpacity>

      <TouchableOpacity style={[styles.button, {backgroundColor:'blue'}]} onPress={() => this.props.navigation.navigate('SadScreen')}>
      <Text style={styles.buttonText}>mathscreen</Text>
      </TouchableOpacity>

      <TouchableOpacity style={[styles.button, {backgroundColor:'blue'}]} onPress={() => this.props.navigation.navigate('SadScreen')}>
      <Text style={styles.buttonText}>physicsscreen</Text>
      </TouchableOpacity>
